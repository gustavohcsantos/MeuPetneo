function calcular_tamanho_roupa_pet(){
    ...
    if((pet.torax <= 26 ) &&
    ...
    else if(((pet.torax > 26) && (pet.torax <= 36 )) &&
    ...
    else if(((pet.torax > 36) && (pet.torax <= 40 )) &&
    ...
    else if(((pet.torax > 40) && (pet.torax <= 48 )) &&
    ...
    else if(((pet.torax > 48) && (pet.torax <= 52) ) &&
    ...
    else if(((pet.torax > 52) && (pet.torax <= 60)) &&
    ...
    else if(((pet.torax > 60) && (pet.torax <= 62)) &&
    ...
    else if(((pet.torax > 62) && (pet.torax <= 69)) &&
    ...
    else if(((pet.torax > 69) && (pet.torax <= 80)) &&
    ...
    else if(((pet.torax > 80) && (pet.torax <= 90)) &&
       ...
       ((pet.peso > 55) && (pet.peso <= 75))){
        ...
        /*var msg = "Os dados informados não correspondem com nossa base de dados.";*/
        var msg = "OS DADOS INFORMADOS NÃO CORRESPONDEM COM NOSSA BASE DE DADOS.";
        document.getElementById("resultado").value = msg;}
}