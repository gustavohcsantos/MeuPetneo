<?php
    ...
    <link rel="stylesheet" href="./css/quem_somos.css" type="text/css" />
...
?>
    <main>
        <div class="bloco_informacoes">
            ...
            <p class="descricao_quem_somos">
                Durante muito tempo fiquei procurando por informações sobre como descobrir as medidas do meu corpinho para eu pedir ao meu tutor comprar lindas roupas que eu via com ele em alguns sites. Ficava maravilhada com os looks e ficava imaginando como eu ficaria usando cada uma.<br /><br />
